...
<body>
	...
	<div class="cont overflow-y-auto">
			...
			<div class="mainbody p-4">
					...
					<form id="profileForm" action="/updateMypage" method="post" enctype="multipart/form-data" style="width: 100%">
					<!-- <form action="/updateMypage" method="post" style="width: 100%"> -->
							...
							<div class="brdimg">
								<c:if test="${sessionScope.login.profileImg == null}">
									<img src="${pageContext.request.contextPath}/assets/img/non.png"
										id="myImage" class="userImage img-fluid shadow-sm w-100 h-100" style="cursor: pointer;">
									</c:if>
								<c:if test="${sessionScope.login.profileImg != null}">
									<img src="${pageContext.request.contextPath}${sessionScope.login.profileImg}"
										id="myImage" class="userImage shadow-sm w-100 h-100" style="cursor: pointer;">
									</c:if>
