...
<script>
	...
	function validateForm() {
	    ...
	    if (emailInput.value.trim() === "") {
	        ...
	        emailSuccess.textContent = ""; // 오류 메시지 제거
	    }
    	...
    	$.ajax({
    		...
    		success : function(cnt) { 
    			...
    			if (cnt == 0) { // cnt가 0일 경우 -> 사용 가능한 아이디 
    				emailSuccess.textContent = "사용가능한 이메일입니다.";
...
<%-- 			<jsp:include page="/WEB-INF/inc/headerNo.jsp"></jsp:include> --%>
		...
		<div class="fs-2" style="text-align: center; font-weight: 1000;">
			...
			<div class="mainbody p-4">
				<form id="registForm" action="/registDo" method="post" onsubmit="return validateForm()" style="width: 100%">
					<div class="row">
						<div class="col">
						...
						<div class="col" style="text-align: end;">
							...
							<label id="emailSuccess" class="text-success mt-3 mx-2"></label>
						</div>
					</div>
					<input class="form-control log fs-3" id="email" name="email" type="text" oninput="emailCheck()" placeholder="이메일을 입력해주세요" />
					...
					<input class="form-control log fs-3" id="password" name="password" type="password" placeholder="비밀번호를 입력해주세요" />
					...
					<input class="form-control log fs-3" id="name" name="nickName" type="text" placeholder="이름을 입력해주세요" />
			...
			<div class="d-flex justify-content-center mb-4">
				<label class="fs-5" style="color: #ABABAB;">이미 회원이신가요? 
					<a href="${pageContext.request.contextPath}/loginView" style="font-weight: 1000;">
						로그인
					</a>
				</label>
			</div>
