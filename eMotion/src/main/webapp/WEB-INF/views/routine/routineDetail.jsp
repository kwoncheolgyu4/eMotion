...
<body>
	...
	<div class="cont overflow-y-auto">
		...
		<!-- 헤더 영역 -->
		<div class="px-3">
		<form class="routineForm" action="/routineWriteDo" method="post">
			<div class="maincss px-2">
				...
				<span>루틴 이름 (${sessionScope.login.nickName})</span><input
					...
					class="form-control" name="rouDetail"> 
					<label>목적지 	 선택</label>
					 <input type ="hidden" name="startRegion" id="start-region-hidden"></input> 
					<input type ="hidden" name="endRegion" id="end-region-hidden" ></input>
					<span id="start-region" style="color: #888;"></span> 
					<span id="end-region" style="color: #888;"></span>
							...
							<div>
								...
								<div class="carcard w-100 overflow-auto" style="list-style: none; padding: 0;">
									...
									<c:forEach var="car" items="${gSaveCarList}">
										<div class="liststyle p-3 my-2" id="userGhavelist">${car.carName}</div>
									</c:forEach>
								</div>
							</div>
						</div>
						<div class="col">
							...
							<div class="carcard w-100 overflow-auto" style="list-style: none; padding: 0;">
								...
								<c:forEach var="car" items="${eSaveCarList}">
									<div class="liststyle p-3 my-2" id="userEhavelist">${car.carName}</div>
								</c:forEach>
							</div>
							</div>
						</div>
